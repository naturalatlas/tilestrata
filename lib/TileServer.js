 ...
 * @return {void}
 */
TileServer.prototype.serve = function(method, url, headers, callback) {
	...
	handler[_method](this, req, function(status, buffer, headers) {
		headers = headers || {};
		...
		callback(status, buffer, headers);
	});
};
...
TileServer.prototype.listen = function(port, callback) {
	...
	var server = http.createServer(function(req, res) {
		self.serve(req.method, req.url, req.headers, function(status, buffer, headers) {
