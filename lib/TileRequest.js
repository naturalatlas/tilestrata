...
var TileRequest = module.exports = function(x, y, z, layer, filename, headers, method) {
	this.x = x;
	this.y = y;
	this.z = z;
	this.layer = layer;
...
TileRequest.parse = function(url, headers, method) {
	...
	return new TileRequest(x, y, z, layer, filename, headers, method);
};
...
TileRequest.prototype.clone = function() {
	...
	return new TileRequest(this.x, this.y, this.z, this.layer, this.filename, headers, this.method);
};